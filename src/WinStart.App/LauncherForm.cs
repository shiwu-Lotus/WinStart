...
namespace WinStart.App
{
    ...
    public partial class LauncherForm : Form
    {
        ...
        private void LoadLauncherItems()
        {
            ...
            var items = new[]
            {
                new { Name = "记事本", Icon = "assets/notepad.png", Path = "notepad.exe" },
                new { Name = "计算器", Icon = "assets/calc.png", Path = "calc.exe" },
                new { Name = "浏览器", Icon = "assets/browser.png", Path = "https://www.bing.com" }
            };
            ...
            foreach (var item in items)
            {
                ...
                {
                    Console.WriteLine($"加载启动项 {item.Name} 失败: {ex.Message}");
                }
            }
        }
    }
